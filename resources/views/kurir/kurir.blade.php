                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-success"
                                                onclick="ambil({{ $t->id_transaksi }})" id="">Ambil</button>
                            ...
                            <tbody>
                                @foreach ($transaksi_mengambil as $t)
                                    <tr>
                                        ...
                                        <td>{{ $t->status_transaksi }}</td>
                                        <td>
                                            <button type="button" class="btn btn-success diambil"
                                                onclick="diambil({{ $t->id }})" id="">Diambil</button>
                                            <button type="button" class="btn btn-success detail_map">Detail</button>
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <tbody>
                                @foreach ($transaksi_diambil as $t)
                                    <tr>
                                        ...
                                        <td>{{ $t->status_transaksi }}</td>
                                        <td>
                                            <button type="button" class="btn btn-success antri"
                                                onclick="antri({{ $t->id }})" id="">Antri</button>
                                            <button type="button" class="btn btn-success detail_map">Detail</button>
                                        </td>
                                    </tr>
                                @endforeach
                            ...
                            <tbody>
                                @foreach ($transaksi_siap as $t)
                                    <tr>
                                        ...
                                        <td>{{ $t->status_transaksi }}</td>
                                        <td>
                                            <button type="button" class="btn btn-success diantar" id=""
                                                onclick="antar({{ $t->id }})">Antar</button>
                                            <button type="button" class="btn btn-success detail_map">Detail</button>
                                        </td>
                                    </tr>
                                @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-success selesai"
                                                onclick="selesai({{ $t->id }})">Selesai</button>
                                            <button type="button" class="btn btn-success detail_map">Detail</button>
                                        </td>
                                    </tr>
                                @endforeach
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('transaksi_selesai') }}" method="POST">
                        ...
                        <button type="submit" style="float: right;color:white;margin-bottom:20px"
                            class="btn btn-success" id="transaksi_selesai">Selesai</button>
                        <button type="button" style="float: right;color:white;margin-bottom:20px"
                            class="btn btn-primary" id="bayar">Bayar</button>
            ...
            if (pembayaran >= total_harga) {
                $.ajax({
                    ...
                    success: function(data_transaksi) {
                        ...
                        $('#status_pembayaran_akhir').val(data_transaksi.transaksi[0][
                            'status_pembayaran'
                        ]);
                    }
                });
