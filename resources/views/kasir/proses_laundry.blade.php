...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" id=""
                                                class="btn btn-success proses_laundry_kerja"
                                                onclick="proses_laundry({{ $t->id }})">Proses</button>
                            ...
                            <tbody>
                                @foreach ($transaksi_siap as $t)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" id=""
                                                class="btn btn-success proses_laundry_siap" onclick="proses_laundry_siap({{ $t->id }})">Siap</button>
                                            <button type="button" class="btn btn-success detail_map">Detail</button>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <script type="text/javascript">
        ...
        function proses_laundry(id_transaksi) {
            id = id_transaksi;
            $.ajax({
        ...
        function proses_laundry_siap(id_transaksi) {
            id = id_transaksi;
            $.ajax({
