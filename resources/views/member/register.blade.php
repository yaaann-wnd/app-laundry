                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3" action="{{ route('registerProses') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text"
                                        class="form-control form-control-lg @error('nama_member') is-invalid @enderror"
                                        id="nama" placeholder="Masukkan Nama" name="nama_member">
                                    @error('nama_member')
                                ...
                                <div class="form-group">
                                    <input type="text"
                                        class="form-control form-control-lg @error('alamat_member') is-invalid @enderror"
                                        id="alamat" placeholder="Masukkan Alamat" name="alamat_member">
                                    @error('alamat_member')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <input type="text"
                                        class="form-control form-control-lg @error('no_telp_member') is-invalid @enderror"
                                        id="Masukkan Nomor Telepon" placeholder="Masukkan Nomor Telepon"
                                        name="no_telp_member">
